                ...
                <div class="col-lg-6">
                    ...
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/manageProduct">Sản phẩm</a>                           </li>

                            <li><a href="${pageContext.request.contextPath}/manageAccount">Tài khoản</a></li>

                            <li><a href="${pageContext.request.contextPath}/manageFeedback">Đánh giá</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
